    ...
    return (
        ...
        ui.nav(
               'About Us',
                ...
                ui.p(
                """We are a group of inspiring bioinformatics scientists from Applied Human Computational Genomics class(Fall 2022) at Georgia Tech. Joseph Luper Tsenum is a seh1ond year Bioinformatics PhD Student at Georgia Tech, and he is interested in Artificial intelligence for Multiomics data integration for biomarker discovery & drug discovery/repurposing. Xu Qiu is a second year Bioinformatics MS student at Georgia tech. She previously worked with pan-genome of plants and is fascinated by their diverse structure. Xu is interested in building efficient Bioinformatics pipelines and utilizing various open source tools to solve problems. Zun Wang is a second year Bioinformatics MS student at Georgia Tech, and is interested in Artificial Intelligence for public health data. Right now, she is working on deep learning for MRI image data processing, specifically on the Alzheimer's disease."""),
